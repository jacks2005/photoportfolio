...
def build_archive(collections, output_root):
    ...
    content = ('<section class="page-heading"><p class="eyebrow">COLLECTION DIRECTORY</p><h1>Archive</h1>'
               '<p class="intro-copy">A chronological directory of photographic projects.</p></section>')
